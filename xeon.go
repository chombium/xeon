...
// and the template functions that are very-closed to Xeon.
...
//
// The Application can go online with any type of server or xeon's host with the help of
